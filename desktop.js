...
let cms = {
    ...
    'desktop': [
        ...
        `<a onclick="window.open('https://github.com/Qige513/Caixukun12','_blank');" title="https://github.com/Qige513/Caixukun12"><i class="bi bi-github"></i> 在 Github 中查看此项目</a>`,
        `<a onclick="window.open('https://github.com/tjy-gitnub/win12/issues','_blank');" title="https://github.com/tjy-gitnub/win12/issues"><i class="bi bi-chat-left-text"></i> 给原作者发送反馈</a>`,
        ['<i class="bi bi-info-circle"></i> 关于 Cxk12 网页版', `$('#win-about>.about').show(200);$('#win-about>.update').hide();openapp('about');if($('.window.about').hasClass('min'))minwin('about');`],
    ],
    'winx': [
        function (arg) {
